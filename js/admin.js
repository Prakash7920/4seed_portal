...
/*==============================
Action Menu Wrapper Functions
(these are the names used by the
action-menu buttons in the HTML)
==============================*/
...
function editPartnerById(partnerId){
    ...
    editPartner(partner.partnerId, partner.name, partner.wallet);

}

function walletById(partnerId){
    ...
    walletPopup(partner.partnerId, partner.wallet);
...
function togglePartner(partnerId){
    ...
    if(!confirm(`Block/Unblock ${partner.name} (${partner.partnerId})?`)){
        return;
    }

    toggleStatus(partner.partnerId, partner.status);
...
function deletePartner(partnerId){
    ...
    if(!confirm(`Are you sure you want to delete ${partner.name} (${partner.partnerId})? This cannot be undone.`)){
        return;
    }
